...
public class GetActiveCostsQueryHandler : IRequestHandler<GetActiveCostsQuery, ApiResponse<List<CostResponse>>>
{
    private readonly IUnitOfWork unitOfWork;
    private readonly IMapper mapper;
    private readonly ISessionService sessionService;

    public GetActiveCostsQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, ISessionService sessionService)
    {
    ...
    public async Task<ApiResponse<List<CostResponse>>> Handle(GetActiveCostsQuery request, CancellationToken cancellationToken)
    {
